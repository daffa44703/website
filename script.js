...
const fotoRektor = document.querySelector('.foto-rektor');
if (fotoRektor) {
  fotoRektor.addEventListener('error', () => {
    fotoRektor.style.display = 'none';
    const gantiEmoji = document.createElement('div');
    gantiEmoji.textContent = '👨‍💼';
    gantiEmoji.style.cssText = `
      width: 220px;
      height: 220px;
    ...
    `;
    fotoRektor.parentNode.appendChild(gantiEmoji);
  });
}
